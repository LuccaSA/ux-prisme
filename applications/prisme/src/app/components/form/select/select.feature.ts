...
const extra = `un guide d'utilisation des select est disponible sur le <a href="https://github.com/LuccaSA/lucca-front/wiki/Select-and-picker">wiki de lucca-front</a>`;
@Component({
	selector: 'pri-select',
